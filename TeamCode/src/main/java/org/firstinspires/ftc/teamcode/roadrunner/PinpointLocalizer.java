...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2693.149012373161; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 3811.814055044938; // x position of the perpendicular encoder (in tick units)
    }
