...
public class LaunchResult {
    ...
    public LaunchResult(double launchAngle1, double landingAngle1, double maxHeight1, double solutionViable1, double launchAngle2, double landingAngle2, double maxHeight2, double solutionViable2, double launchAngle, double landingAngle, double maxHeight) {
